...
consumerElectronicsDataForAnalysisDayAggregation$gamingAccessoryPropertionate <- consumerElectronicsDataForAnalysisDayAggregation$product_analytic_sub_categoryGamingAccessory_sum / consumerElectronicsDataForAnalysisDayAggregation$totalOrders

consumerElectronicsDataForAnalysisDayAggregation <- consumerElectronicsDataForAnalysisDayAggregation %>% filter(product_analytic_sub_categoryGamingAccessory_sum > 0)

...
consumerElectronicsDataForAnalysisDayAggregation$cameraAccesorryPropertionate <- consumerElectronicsDataForAnalysisDayAggregation$product_analytic_sub_categoryCameraAccessory_sum / consumerElectronicsDataForAnalysisDayAggregation$totalOrders

consumerElectronicsDataForAnalysisDayAggregation <- consumerElectronicsDataForAnalysisDayAggregation %>% filter(product_analytic_sub_categoryCameraAccessory_sum > 0)

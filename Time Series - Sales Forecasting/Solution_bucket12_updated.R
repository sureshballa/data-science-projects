...
#DKA not 48 obsevations and month repeats so using seq to have month numbers
timevals_in <- seq(1:48) #indata$cmonth
...
timevals_out <- c(43:48) #rawdata[43:48] #<- outdata$cmonth
#outdata$totalsales<-log(outdata$totalsales)
rawdata$totalsales[43:48]
